# SecureINT: Security-enhanced in-band network telemetry (INT)
...
## Citing
All codes **can only be used for academic research**. If you used our code ***SecureINT*** or our ***attacks against INT***, please cite:
