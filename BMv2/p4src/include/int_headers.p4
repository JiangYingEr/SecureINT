...
const bit<16> INT_PER_HOP_METADATA_SIZE = 44 + 4;
...
//keys for encrypt INT Metadata
header int_metadata_keys_t {
    bit<32> int_switch_id_key;
    bit<32> int_port_ids_key;
    bit<32> int_hop_latency_key;
    bit<32> int_q_occupancy_key;
    bit<32> int_timestamp_key;
...
struct headers {
    ...
    //INT Metadata keys
    //int_metadata_keys_t         int_metadata_keys;
